...
public abstract class SO {
	...
	public enum Escalonador {
		...
		SHORTEST_REMAINING_TIME_ADIVINHA // SRTF que sabe o tamanho do burst de CPU
	}
	...
	private void imprimeEstatisticas() {
		System.out.println(tempoRetornoMedio() + "\t" + tempoRespostaMedio() + "\t" + tempoEsperaMedio() + "\t" + trocasContexto());
