...
public class Gerente extends Pessoa implements InterfaceGerente{
	...
	public boolean adicionarCliente(Cliente cliente) {
		...
		if ( jaEsta(cliente) ) return false;
	...
	/* Verifica se o cliente ja foi inserido no array CLiente clientes[]
	*  Caso o cliente passado como parametro ja se encontra no array, retorna true;
	*  Caso contrario, retorna false;
	*/ 
	boolean jaEsta(Cliente cliente){

		for (int i = 0; i < numClientes; i++){
			if (cliente.cpf == clientes[i].cpf) return true;
		}
